...
const SOCIAL_TYPES = [
    { key: "instagram", icon: "instagram", labelKey: "Instagram", placeholder: "instagram.com/yourvenue" },
    { key: "tiktok", icon: "music-note-outline", labelKey: "TikTok", placeholder: "tiktok.com/@yourvenue" },
    { key: "facebook", icon: "facebook", labelKey: "Facebook", placeholder: "facebook.com/yourvenue" },
    { key: "website", icon: "web", labelKey: "Website", placeholder: "yourvenue.com" },
];
...
export default function VenueSocialMediaStep({ initial, submitLabel, onSubmit, onDone }) {
            ...
            >
                ...
                <View className="mt-3">
                    <Text className="text-white/55 text-xs text-center leading-4">
                        {t("Padoms: vari ielīmēt pilnu linku vai tikai lietotājvārdu (piem., @zeit_radosais_kvartals).")}
                    </Text>
                </View>
            </ScrollView>
        </View>
